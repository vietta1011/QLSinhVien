...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer(DB.ConnectString);
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Diem>(entity =>
            {
                entity.HasKey(e => new { e.MaDiem, e.MaMonHoc, e.MaSv })
                    .HasName("PK__Diem__AC07321A3B87FB0B");
            ...
            modelBuilder.Entity<Lop>(entity =>
            {
                entity.HasKey(e => e.MaLop)
                    .HasName("PK__Lop__3B98D27364816548");
            ...
            modelBuilder.Entity<MonHoc>(entity =>
            {
                entity.HasKey(e => e.MaMh)
                    .HasName("PK__MonHoc__2725DF399937DA43");
            ...
            modelBuilder.Entity<Nghanh>(entity =>
            {
                entity.HasKey(e => e.MaNghanh)
                    .HasName("PK__Nghanh__292470ADC85E100C");
            ...
            modelBuilder.Entity<SinhVien>(entity =>
            {
                entity.HasKey(e => e.MaSv)
                    .HasName("PK__SinhVien__2725087A1B3ACDC6");
